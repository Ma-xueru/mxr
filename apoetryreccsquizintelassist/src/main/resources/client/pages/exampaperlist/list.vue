	...
	<mescroll-uni @init="mescrollInit" :up="upOption" :down="downOption" @down="downCallback" @up="upCallback">
        <view :style='{"padding":"20rpx 0 0 0","alignItems":"center","flex":"1","display":"flex","width":"calc(98% - 120rpx)","position":"relative","justifyContent":"space-between"}'>
            <view :style='{"backgroundColor":"#f5f5f5","margin":"0 30rpx 0 30rpx","color":"#333333","alignItems":"center","borderRadius":"0px","flex":"1","display":"flex","lineHeight":"64rpx","fontSize":"24rpx","height":"64rpx"}'>
                ...
                <input v-model="searchForm.name" type="text" placeholder="古诗词测试名称" :style='{"background":"transparent","height":"100%"}'></input>
            </view>
			...
			<view class="list">
				<view @tap="onDetailTap(item.id)" v-for="(item,index) in list " v-bind:key="index" class="listm flex flex-between">
					...
					<view class="listmr">
						...
						<view class="colb f24 lh35">时长：{{item.time}}分钟</view>
						<view class="flex flex-align-center mt20">
							<text class="colb f25">
								<button class="cu-btn bg-green shadow">点击练习</button>
							</text>
						</view>
					</view>
				</view>
