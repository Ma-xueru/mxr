...
<mescroll-uni @init="mescrollInit" :up="upOption" :down="downOption" @down="downCallback" @up="upCallback">
		...
		<view :style='{"minHeight":"100vh","width":"100%","padding":"20rpx 0 0 0","position":"relative","background":"#ffffff","height":"100%"}'>
			...
			<view class="uni-product-list" :style='{"padding":"24rpx 24rpx 24rpx 24rpx","margin":"40rpx 0 0 0","alignItems":"flex-start","flexWrap":"wrap","display":"flex","width":"100%","justifyContent":"space-between","height":"auto"}'>
				<view @tap="onDetailTap(product)" class="uni-product" :style='{"boxShadow":"0 0px 0px #eeeeee","margin":"0 0 40rpx 0","backgroundColor":"#ffffff","borderRadius":"8rpx","flexWrap":"wrap","textAlign":"center","display":"flex","width":"48%","justifyContent":"center","height":"auto"}' v-for="(product,index) in list" :key="index">
					<view class="uni-product-title" :style='{"padding":"0px 20rpx 0px 20rpx","margin":"0 0 0px 0","whiteSpace":"nowrap","color":"#333333","textAlign":"left","overflow":"hidden","borderRadius":"8rpx","width":"100%","lineHeight":"72rpx","fontSize":"28rpx","textOverflow":"ellipsis","order":"2","height":"72rpx"}'>用户账号:{{product.studentaccount}}</view>
	...
	<view :style='{"width":"80%","padding":"40rpx 20rpx","background":"#fdfbd9"}' class="screenBox" :class="screenBoxShow?'screenBoxActive':''">
		<view :style='{"width":"100%","padding":"20rpx 20rpx 20rpx 0","alignItems":"center","justifyContent":"space-around","display":"flex"}'>
			...
			<input :style='{"border":"2rpx solid #dddddd","padding":"0 20rpx 0 20rpx","borderRadius":"8rpx","color":"#666666","background":"#ffffff","width":"80%","height":"60rpx"}' placeholder="请输入用户姓名" v-model="searchForm.studentname">
		</view>
	...
	export default {
		...
		methods: {
			...
			studentaccountChange(e){
				this.searchForm.studentaccount = e
				this.$forceUpdate()
			},
			screenReset(){
				this.searchForm = {}
			...
			async upCallback(mescroll) {
                ...
                let res = {}
                if(this.userid) {
                    res = await this.$api.page(`transcript`, params);
                } else {
                    res = await this.$api.list(`transcript`, params);
                }
				// 如果是第一页数据置空
			...
			async search(){
                ...
                let res = {};
                if(this.userid) {
                    res = await this.$api.page(`transcript`, searchForm);
                } else {
                    res = await this.$api.list(`transcript`, searchForm);
                }
				// 如果是第一页数据置空
