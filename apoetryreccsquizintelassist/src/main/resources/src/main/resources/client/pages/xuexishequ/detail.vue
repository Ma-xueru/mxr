	...
	<view class="content">
		<view class="container" :style='{"width":"100%","padding":"0px","position":"relative","background":"#ffffff","height":"auto"}'>
				...
				<view :style='{"margin":"16rpx 0 16rpx 0","borderColor":"#f0b8dd","flexWrap":"wrap","borderWidth":"0 0 2rpx 0","background":"#ffffff","display":"flex","width":"100%","borderStyle":"dotted","height":"auto"}' class="detail-list-item title">
					<view :style='{"width":"auto","padding":"0 20rpx 0 0","lineHeight":"60rpx","fontSize":"28rpx","color":"#5fb959","textAlign":"right"}' class="lable">贴子标题：</view>
					<view :style='{"padding":"0px 0 0 0","margin":"0 0 0 0","lineHeight":"60rpx","fontSize":"28rpx","color":"#666666","flex":"1"}' class="text">{{detail.forumtitle}}</view>
				</view>
				<view :style='{"margin":"16rpx 0 16rpx 0","borderColor":"#f0b8dd","flexWrap":"wrap","borderWidth":"0 0 2rpx 0","background":"#ffffff","display":"flex","width":"100%","borderStyle":"dotted","height":"auto"}' class="detail-list-item title">
					<view :style='{"width":"auto","padding":"0 20rpx 0 0","lineHeight":"60rpx","fontSize":"28rpx","color":"#5fb959","textAlign":"right"}' class="lable">发布时间：</view>
					<view :style='{"padding":"0px 0 0 0","margin":"0 0 0 0","lineHeight":"60rpx","fontSize":"28rpx","color":"#666666","flex":"1"}' class="text">{{detail.releasetime}}</view>
				</view>
				...
				<view class="detail-list-item rich" :style='{"margin":"24rpx 0 44rpx 0","borderColor":"#cccccc","borderRadius":"8rpx 0 0 8rpx","borderWidth":"0 0 0px 0","background":"#ffffff","display":"block","width":"100%","borderStyle":"solid","height":"auto"}'>
					<view class="lable" :style='{"padding":"0 24rpx 0 24rpx","margin":"0 0 0px","borderColor":"#f0b8dd","color":"#d84fa9","textAlign":"left","background":"#fff","borderWidth":"0 0 2rpx 0","width":"100%","lineHeight":"60rpx","fontSize":"32rpx","borderStyle":"dotted","fontWeight":"500"}'>帖子内容</view>
					<view class="rich-text" :style='{"padding":"12rpx 24rpx 24rpx","margin":"20rpx 0 0 0","lineHeight":"48rpx","color":"#666666","background":"#5fb95910"}'>
						<rich-text :nodes="detail.forumcontent"></rich-text>
					</view>
				</view>
...
<script>
	export default {
		...
		async onShow(options) {
			...
			this.getThumbsup();
			let cleanType = uni.getStorageSync('discussforumCleanType')
			if(cleanType){
				uni.removeStorageSync('discussforumCleanType')
				this.mescroll.num = 1
            ...
            if(crossCleanType) {
                ...
                res = await this.$api.info('forum', this.id);
		...
		methods: {
			...
			async init(){
				...
				//修改富文本的图片样式
				this.detail.forumcontent = this.detail.forumcontent.replace(/img src/gi,"img style=\"width:100%;\" src");
			},
			...
			async upCallback(mescroll) {
                let res = await this.$api.list('discussforum', {
					page: mescroll.num,
					limit: 10,
					refid: this.id
				});
