	...
	<view :style='{"width":"100%","padding":"0 0 0 0","position":"relative","background":"#ffffff","height":"100%"}'>
		<form :style='{"width":"100%","padding":"24rpx 24rpx 24rpx 24rpx","background":"#ffffff","display":"block","height":"auto"}' class="app-update-pv">
			...
			<view :style='{"padding":"4rpx 0 4rpx 0","margin":"0 0 24rpx 0","borderColor":"#eeeeee","alignItems":"center","borderWidth":"0px 0px 2rpx 0px","background":"none","display":"flex","width":"100%","borderStyle":"solid","height":"auto"}' class="">
				...
				<input :style='{"border":"0px solid #eeeeee","padding":"0px 24rpx 0px 24rpx","margin":"0 0 0 0","color":"#666666","borderRadius":"8rpx","flex":"1","background":"#ffffff00","fontSize":"28rpx","lineHeight":"80rpx","height":"80rpx"}' :disabled="ro.feedbacktitle" v-model="ruleForm.feedbacktitle" placeholder="反馈标题"></input>
			</view>
			<view :style='{"padding":"4rpx 0 4rpx 0","margin":"0 0 24rpx 0","borderColor":"#eeeeee","alignItems":"center","borderWidth":"0px 0px 2rpx 0px","background":"none","display":"flex","width":"100%","borderStyle":"solid","height":"auto"}' class="">
				...
				<input :style='{"border":"0px solid #eeeeee","padding":"0px 24rpx 0px 24rpx","margin":"0 0 0 0","color":"#666666","borderRadius":"8rpx","flex":"1","background":"#ffffff00","fontSize":"28rpx","lineHeight":"80rpx","height":"80rpx"}' v-model="ruleForm.feedbacktime" placeholder="反馈时间" @tap="toggleTab('feedbacktime')"></input>
			</view>
			...
			<view :style='{"padding":"12rpx 0 12rpx 0","margin":"0 0 24rpx 0","borderColor":"#eeeeee","borderWidth":"0 0 0px 0","width":"100%","borderStyle":"solid","height":"auto"}' class="">
                ...
                <xia-editor ref="editor" :style='{"minHeight":"300rpx","border":"2rpx solid #eeeeee","padding":"20rpx","color":"#666666","background":"none","width":"100%","height":"auto"}' v-model="ruleForm.feedbackcontent" placeholder="反馈内容" @editorChange="feedbackcontentChange"></xia-editor>
			</view>
		...
		<w-picker mode="dateTime" step="1" :current="false" :hasSecond="false" @confirm="feedbacktimeConfirm" ref="feedbacktime" themeColor="#333333"></w-picker>
	</view>
</view>
</template>
...
<script>
	...
	export default {
		...
		async onLoad(options) {
            this.ruleForm.feedbacktime = this.$utils.getCurDateTime();
			...
			if (options.id) {
				...
				// 获取信息
				res = await this.$api.info(`feedback`, this.ruleForm.id);
			...
			if(options.cross){
				...
				for (var o in obj){
					...
					if(o=='feedbacktitle'){
					this.ruleForm.feedbacktitle = obj[o];
					this.ro.feedbacktitle = true;
					continue;
					}
					if(o=='feedbackcontent'){
					this.ruleForm.feedbackcontent = obj[o];
					this.ro.feedbackcontent = true;
					continue;
					}
					if(o=='feedbacktime'){
		...
		methods: {
            feedbackcontentChange(e) {
                this.ruleForm.feedbackcontent = e
            },
			styleChange() {
				this.$nextTick(()=>{
			...
			// 日长控件选择日期时间
			feedbacktimeConfirm(val) {
				console.log(val)
				this.ruleForm.feedbacktime = val.result;
				this.$forceUpdate();
			},
...
//跨表计算判断
				var obj;
				if((!this.ruleForm.feedbacktitle)){
				...
				if(crossrefid && crossuserid) {
					...
					let res = await this.$api.list(`feedback`, params);
                ...
                //跨表计算
						if(this.ruleForm.id){
							await this.$api.update(`feedback`, this.ruleForm);
						}else{
							await this.$api.add(`feedback`, this.ruleForm);
						}
