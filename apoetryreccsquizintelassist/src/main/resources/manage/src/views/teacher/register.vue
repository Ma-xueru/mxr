		...
		<div class="register_view">
			<el-form :model="registerForm" class="register_form">
				...
				<div class="list_item">
					...
					<el-input class="list_inp" v-model="registerForm.teacherpassword2" type="password" placeholder="请输入确认教师密码" />
				</div>
				<div class="list_item">
...
<script setup>
	...
	const handleRegister = () => {
		...
		if(registerForm.value.teacherpassword!=registerForm.value.teacherpassword2){
			context?.$toolUtil.message('两次密码输入不一致','error')
			return false
		}
		if((!registerForm.value.teachername)){
