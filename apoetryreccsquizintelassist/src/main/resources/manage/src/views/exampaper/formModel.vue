	...
	<div>
		<el-dialog v-model="formVisible" :title="formTitle" width="80%" destroy-on-close :fullscreen='false'>
			<el-form class="formModel_form" ref="formRef" :model="form" label-width="$template2.back.add.form.base.labelWidth" :rules="rules">
				<el-row>
					<el-col :span="12">
						<el-form-item label="古诗词测试名称" prop="name">
							<el-input class="list_inp" v-model="form.name" placeholder="古诗词测试名称"
					...
					<el-col :span="12">
						<el-form-item label="时长(分钟)" prop="time">
							<el-input class="list_inp" v-model.number="form.time" placeholder="时长(分钟)"
								 type="text" 								:readonly="!isAdd||disabledForm.time?true:false" />
						</el-form-item>
					</el-col>

					<el-col :span="12">
						<el-form-item label="古诗词测试状态" prop="status">
							<el-select
								class="list_sel"
								:disabled="!isAdd||disabledForm.status?true:false"
								v-model="form.status" 
								placeholder="请选择古诗词测试状态"
								>
