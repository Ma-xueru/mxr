		...
		<el-dialog v-model="formVisible" :title="formTitle" width="80%" destroy-on-close :fullscreen='false'>
			<el-form class="formModel_form" ref="formRef" :model="form" label-width="$template2.back.add.form.base.labelWidth" :rules="rules">
				<el-row>
					...
					<el-col :span="12">
						<el-form-item label="贴子标题" prop="forumtitle">
							<el-input class="list_inp" v-model="form.forumtitle" placeholder="贴子标题"
								 type="text" 								:readonly="!isAdd||disabledForm.forumtitle?true:false" />
						</el-form-item>
					</el-col>
					...
					<el-col :span="24">
						<el-form-item label="帖子内容" prop="forumcontent">
							<editor :value="form.forumcontent" placeholder="请输入帖子内容" :readonly="!isAdd||disabledForm.forumcontent?true:false"
								class="list_editor" @change="(e)=>editorChange(e,'forumcontent')"></editor>
						</el-form-item>
					</el-col>
				</el-row>
			</el-form>
...
<script setup>
	...
	const getInfo = ()=>{
		context?.$http({
			...
			res.data.data.forumcontent = res.data.data.forumcontent?(res.data.data.forumcontent.replace(reg,'../../../apoetryreccsquizintelassist/file')):'';
	...
	const init=(formId=null,formType='add',formNames='',row=null,table=null,statusColumnName=null,tips=null,statusColumnValue=null)=>{
		...
		if(formType == 'add'){
			...
			for(let x in row){
				...
				if(x=='forumtitle'){
					form.value.forumtitle = row[x];
					disabledForm.value.forumtitle = true;
					continue;
				}
				if(x=='forumcontent'){
					form.value.forumcontent = row[x];
					disabledForm.value.forumcontent = true;
					continue;
				}
				if(x=='releasetime'){
